...
resource "aws_elb" "elb" {
  ...
  instances                   = ["${aws_spot_instance_request.rancherha.*.spot_instance_id}"]
...
resource "aws_spot_instance_request" "rancherha" {
...
data "template_file" "segment" {
  count = "${var.instance_count}"
  template = "- address: ${aws_spot_instance_request.rancherha.*.public_ip[count.index]}\n  internal_address: ${aws_spot_instance_request.rancherha.*.private_ip[count.index]}\n  user: ubuntu\n  role: [controlplane,etcd,worker]"
}
